...
export declare class CardPrimaryAction extends React.Component<RMWC.SimpleBaseProps<CardPrimaryAction>> { }
...
export declare class CardActionButtons extends React.Component<RMWC.SimpleBaseProps<CardActionButtons>> { }
export declare class CardActionIcons extends React.Component<RMWC.SimpleBaseProps<CardActionIcons>> { }
